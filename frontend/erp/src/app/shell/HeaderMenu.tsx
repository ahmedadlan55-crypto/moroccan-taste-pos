  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        aria-expanded={open}
        onClick={() => setOpen((o) => !o)}
        className="grid min-h-10 min-w-10 place-items-center rounded-xl border border-slate-200 bg-white text-slate-600 transition hover:border-slate-300 hover:text-slate-900"
      >
        {trigger}
      </button>
      {open && (
