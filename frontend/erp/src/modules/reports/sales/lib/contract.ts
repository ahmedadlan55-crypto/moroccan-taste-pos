...
export const METRIC_FACTS: Record<string, readonly FactId[]> = {
  ...
  cogs: ["line"],
  returns_cogs: ["return"],
  returns_cogs_reversed: ["return"],
  uncosted_net: ["line"],
  uncosted_returns_net: ["return"],
  payments_in: ["payment"],
  refunds_out: ["payment"],
  tips_total: ["order"],
  fees_total: ["order"],
  ...
  gross_profit: ["line"],
  margin_pct: ["line"],
  cogs_after_returns: ["line", "return"],
  gross_profit_after_returns: ["line", "return"],
  margin_pct_after_returns: ["line", "return"],
...
export const METRIC_CAPS: Record<string, string> = {
  ...
  returns_cogs_reversed: "analytics.cost.view",
  uncosted_net: "analytics.cost.view",
  uncosted_returns_net: "analytics.cost.view",
  gross_profit: "analytics.cost.view",
  margin_pct: "analytics.cost.view",
  cogs_after_returns: "analytics.cost.view",
  gross_profit_after_returns: "analytics.cost.view",
  margin_pct_after_returns: "analytics.cost.view",
