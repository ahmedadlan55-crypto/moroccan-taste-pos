...
export const stocktakeDialog = {
  ...
  /** نماذج الجرد المحفوظة — مجموعة مسمّاة من المواد التي تُجرد دوريًا:
   *  تُنشأ مرة، ثم تُختار ويُعدَّل عليها بدل إعادة البحث عن ثلاثين مادة يدويًا. */
  templates: {
    label: "نموذج جرد محفوظ",
    ...
    remove: "حذف",
    namePrompt: "اسم النموذج",
    nameRequired: "اكتب اسمًا للنموذج",
    emptyCart: "أضف مواد أولًا ثم احفظها كنموذج",
    saved: "حُفظ النموذج «{name}»",
    updated: "حُدِّث النموذج «{name}»",
    deleted: "حُذف النموذج",
    applied: "حُمِّل {count} مادة من النموذج",
    loadFailed: "تعذّر تحميل النماذج",
    saveFailed: "تعذّر حفظ النموذج",
