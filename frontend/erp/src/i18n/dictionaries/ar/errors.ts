...
export const errors = {
  ...
  FORBIDDEN: "لا تملك صلاحية عرض هذا التقرير",
  UNKNOWN_REPORT: "هذا التقرير غير متاح",
  PRINT_LIMIT: "نتيجة التقرير أكبر من حد الطباعة الآمنة — ضيّق الفلاتر أو صدّرها بصيغة CSV",
  REPORT_SNAPSHOT_LIMIT: "نتيجة التقرير أكبر من حد اللقطة الكاملة — ضيّق الفترة أو نطاق المستودع ثم أعد المحاولة",
  DATE_RANGE_INVALID: "تاريخ البداية يجب ألا يكون بعد تاريخ النهاية",
  // Menu D2/D3 — رُفض تعديل التكلفة يدويًا لأنها مشتقّة من الوصفة؛ صفحة المنتج
  // تعرض هذا كخطوة «فتح القفل للتعديل».
  COST_LOCKED_BY_RECIPE: "هذه التكلفة مشتقّة من الوصفة — افتح القفل من صفحة المنتج لتعديلها يدويًا",
} as const;
