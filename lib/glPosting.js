...
const CORE_ACCOUNTS = {
  ...
  INVENTORY:         { code: '1200', nameAr: 'المخزون الرئيسي',          type: 'asset',     parent: '12'  },
  BRANCH_INVENTORY:  { code: '1210', nameAr: 'مخزون الفروع',             type: 'asset',     parent: '12'  },
  WIP:               { code: '1220', nameAr: 'الإنتاج تحت التشغيل',      type: 'asset',     parent: '12'  },
  FINISHED_GOODS:    { code: '1230', nameAr: 'المنتجات التامة',          type: 'asset',     parent: '12'  },
  ...
  PPV:               { code: '5350', nameAr: 'فروق سعر المشتريات',       type: 'expense',   parent: '53'  },
  LABOR_APPLIED:     { code: '5400', nameAr: 'العمالة المحملة',           type: 'expense',   parent: '54'  },
  OVERHEAD_APPLIED:  { code: '5410', nameAr: 'التكاليف غير المباشرة',     type: 'expense',   parent: '54'  },
  PRODUCTION_VARIANCE:{ code: '5420', nameAr: 'فروقات الإنتاج',           type: 'expense',   parent: '54'  },
