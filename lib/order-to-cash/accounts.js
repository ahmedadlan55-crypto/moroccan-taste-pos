...
function codes() {
  return {
    ar: String(process.env.O2C_AR_ACCOUNT_CODE || '1150'),
    cash: String(process.env.O2C_CASH_ACCOUNT_CODE || '1110'),
    bank: String(process.env.O2C_BANK_ACCOUNT_CODE || '1120'),
    revenue: String(process.env.O2C_REVENUE_ACCOUNT_CODE || '4100'),
    outputVat: String(process.env.O2C_OUTPUT_VAT_ACCOUNT_CODE || '2210'),
    cogs: String(process.env.O2C_COGS_ACCOUNT_CODE || '5100'),
    inventory: String(process.env.O2C_INVENTORY_ACCOUNT_CODE || '1200'),
    deposits: String(process.env.O2C_CUSTOMER_DEPOSITS_CODE || '2140'),
  };
}
