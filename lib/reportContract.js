...
const SORT_WHITELIST = {
  ...
  'no-movement':       { last: 'last_movement', name: 'i.name', qty: 'ws.qty', value: 'line_value' },
  'expiry':            { expiry: 'pl.expiry_date', qty: 'pl.qty_remaining', value: 'lot_value', item: 'item_name' },
...
function pushWarning(list, code, message, level) {
  (list || []).push({ code, message, level: level || 'info' });
  return list;
}
