...
const CODES = {
  ...
  // Phase P1 — production orders V2
  OVER_ISSUE: 'OVER_ISSUE',
  OVER_PRODUCTION: 'OVER_PRODUCTION',
  NO_OUTPUT_RECORDED: 'NO_OUTPUT_RECORDED',
  WASTE_ALLOWANCE_EXCEEDED: 'WASTE_ALLOWANCE_EXCEEDED',
  // Phase U — units of measure
  ...
  DUPLICATE_BASE_UNIT: 'DUPLICATE_BASE_UNIT',
  BARCODE_UNIT_CONFLICT: 'BARCODE_UNIT_CONFLICT',
};
...
const HTTP_FOR = {
  ...
  OVER_ISSUE: 422,
  OVER_PRODUCTION: 422,
  NO_OUTPUT_RECORDED: 422,
  WASTE_ALLOWANCE_EXCEEDED: 403,
  // Phase U — units of measure
  UNIT_REQUIRED: 422,
  ...
  DUPLICATE_BASE_UNIT: 422,
  BARCODE_UNIT_CONFLICT: 409,
};
