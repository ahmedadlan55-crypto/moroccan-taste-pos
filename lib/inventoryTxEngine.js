...
// Receipt (stock IN, not a purchase): Dr inventory / Cr stock-gain.
function glReceipt(o) {
  ...
  return Object.assign(_base(o), {
    ...
    entries: [
      ...
      Object.assign({ accountCode: A.STOCK_GAIN.code, debit: 0, credit: amt }, _dims(o)),
    ],
  });
}
...
async function applyStockMovement(conn, warehouseId, itemId, qtyDelta, unitCost, triggerType, refId, changedBy) {
