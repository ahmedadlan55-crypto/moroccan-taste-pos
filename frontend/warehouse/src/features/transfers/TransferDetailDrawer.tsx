...
} from "@/lib/hooks/useTransferMutations";
...
import { transferStatusToLabel } from "@/lib/status-labels";
import type { TransferDetail, TransferLine } from "@/lib/adapters/transfer.adapter";
    ...
    <>
      <Drawer
        ...
        footer={data ? <Footer
          ...
          onEdit={() => { onClose(); navigate(`/transfers/new?edit=${data.id}`); }}
        /> : undefined}
      >
        {isLoading ? (
          <LoadingState rows={2} />
