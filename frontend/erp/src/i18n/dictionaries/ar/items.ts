...
export const items = {
  ...
  form: {
    ...
    field: {
      ...
      // اختياري على الأصناف القائمة: العمود nullable عمدًا والأصناف القديمة
      // سابقة لإضافته. حقل فارغ بلا توضيح يبدو كبيانات ضائعة.
      codeOptionalHint: "هذا الصنف بلا SKU — الحقل اختياري للأصناف القديمة.",
      codeEmptyPlaceholder: "بلا SKU",
      nameAr: "الاسم (عربي)",
      nameEn: "الاسم (إنجليزي)",
      descAr: "الوصف (عربي)",
