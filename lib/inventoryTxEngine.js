...
// Every warehouse shares one inventory control account. Warehouse/branch are
// dimensions in gl_entries and inventory detail lives in the subledger.
function inventoryAccountFor(_wh) {
  return A.INVENTORY.code;
}
