// Centralized TanStack Query keys for the Order-to-Cash domain. One namespace
// ("orderToCash") so invalidation is precise and collision-free. Ported verbatim
// from the standalone O2C app.
