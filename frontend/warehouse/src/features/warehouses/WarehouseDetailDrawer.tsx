...
import { formatCurrency, formatNumber, formatDateTime, formatQty } from "@/lib/formatters";
import { warehouseHealth, warehouseTypeLabel } from "@/lib/status-labels";
...
// ── آخر الحركات ──────────────────────────────────────────────────────────────
function MovementsTab({ data }: { data: import("@/lib/adapters/warehouse-admin.adapter").WarehouseMovementRow[] }) {
  if (!data.length) {
