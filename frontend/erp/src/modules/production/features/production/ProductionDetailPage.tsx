...
import { productionStatusToLabel, PRODUCTION_PARTIAL_LABEL } from "@/modules/inventory/lib/status-labels";
    ...
    <div>
      <PageHeader
        ...
        action={
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button variant="ghost" onClick={() => navigate("/inventory/production")}><ArrowRight className="h-4 w-4" /> القائمة</Button>
          </div>
        }
      />
      ...
      {active && o.source === "v2" && (
        <div className="surface mb-4 flex flex-wrap items-center gap-2 p-3">
          ...
          {active.edit && <Button variant="secondary" onClick={() => navigate(`/inventory/production?new=1&edit=${o.id}`)}>تعديل المسودة</Button>}
