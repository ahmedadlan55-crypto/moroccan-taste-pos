...
const DIMENSIONS = Object.freeze([
  ...
  },
  {
    ...
    facts: Object.freeze({ line: 'd.category_id_snapshot' }),
  },
  {
  ...
  // ── reasons ───────────────────────────────────────────────────────────────
  {
    // No order-fact column carries a discount reason today (sales.discount_name
    // is not projected) — the dimension exists in the contract but no fact
    // supports it yet. The planner must reject it until a projector lands.
