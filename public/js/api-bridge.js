...
(function() {
  ...
  const ROUTE_MAP = {
    ...
    getPositionWorkflow: { method: 'GET',  url: (posId) => '/workflow/position-workflow/' + posId },
    ...
    getExpenseCategories: { method: 'GET', url: '/workflow/expense-categories' },
    saveExpenseCategory:  { method: 'POST', url: '/workflow/expense-categories' },
    deleteExpenseCategory:{ method: 'DELETE', url: (id) => '/workflow/expense-categories/' + id },
    getWfOutboxSummary:   { method: 'GET', url: '/workflow/outbox-summary', query: (f) => f },
    markTxnRead:          { method: 'POST', url: (id,d) => '/workflow/transactions/' + id + '/mark-read', body: (id,d) => d },
