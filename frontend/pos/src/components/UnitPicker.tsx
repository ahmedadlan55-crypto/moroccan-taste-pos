        ...
        >
          <div className="relative mb-1">
            ...
            <input
              ...
              aria-label="بحث عن وحدة"
              className="field h-9 pe-8 text-xs"
            />
          </div>
          <ul className="max-h-56 overflow-y-auto">
            {filtered.length === 0 ? (
              <li className="px-2 py-2 text-[11px] font-bold text-slate-400">لا وحدة مطابقة.</li>
            ) : (
              filtered.map((u) => (
                <li key={u.unitCode}>
                  <button
                  ...
                  >
                    <span className="truncate">
                      ...
                      {!u.isBase ? (
                        ...
                        <span className="ms-1 text-[10px] font-bold text-slate-400">أساسية</span>
                      )}
                    </span>
