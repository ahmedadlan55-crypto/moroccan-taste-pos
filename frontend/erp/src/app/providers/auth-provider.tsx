...
import type { Role, SessionUser } from "@/app/permissions";

// Auth provider — decodes the JWT the legacy app already stored in localStorage
// (pos_token) so the unified Back-Office shares one session. No login screen
// here: if there's no/expired token the app shows a gentle "sign in from the
// main app" state (handled by RequireAuth).
