...
export const salesReports = {
  ...
  basis: {
    ...
    treatment: "المعالجات",
    treatmentBody:
      "الطلبات الملغاة مستبعَدة من كل الأعداد والقيم؛ المرتجعات مطروحة في الفترة التي سُجِّلت فيها لا فترة البيع الأصلي؛ التكلفة من لقطة وقت البيع لا من تكلفة اليوم.",
