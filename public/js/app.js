...
const dict = {
  ar: {
    ...
    "nav.companies":"الشركات", "nav.brands":"البراندات", "nav.branches":"الفروع",
    "nav.posTerminals":"أجهزة POS", "nav.royaltyRuns":"احتساب الفرانشايز",
    "nav.auditLog":"سجل العمليات",
    "nav.workflow":"المعاملات الإدارية", "nav.wfHub":"مركز المعاملات", "nav.hrHub":"مركز الموارد البشرية", "nav.wfDashboard":"لوحة المعاملات",
  ...
  en: {
    ...
    "nav.companies":"Companies", "nav.brands":"Brands", "nav.branches":"Branches",
    "nav.posTerminals":"POS Terminals", "nav.royaltyRuns":"Franchise Calculation",
    "nav.auditLog":"Audit Log",
    "nav.workflow":"Workflow", "nav.wfHub":"Transactions Hub", "nav.hrHub":"HR Hub", "nav.wfDashboard":"Workflow Dashboard",
...
// =========================================
// Receipt (delegated to /shared/receipt-template.js)
// =========================================
// v6.19.0 — Removed the old admin-specific printReceipt/printReceiptWindow
// implementations.  Both functions are now provided as globals by
// /shared/receipt-template.js (window.MTReceipt) so admin reprints
// produce byte-identical HTML to the POS customer receipt.
// Old call sites continue to work via the backward-compat aliases.
