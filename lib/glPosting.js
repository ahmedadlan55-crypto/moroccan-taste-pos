...
// Inventory is intentionally one control account (1200); warehouse, item,
...
const CORE_ACCOUNTS = {
  // ─── Assets ───
  CASH:              { code: '1110', nameAr: 'النقدية',                  type: 'asset',     parent: '100100' },
  BANK:              { code: '1120', nameAr: 'البنوك',                   type: 'asset',     parent: '100100' },
  AR:                { code: '1150', nameAr: 'ذمم العملاء',              type: 'asset',     parent: '100200' },
  ...
  INPUT_VAT:         { code: '1290', nameAr: 'ضريبة المدخلات',           type: 'asset',     parent: '100450' },
  // ─── Liabilities ───
  AP:                { code: '2100', nameAr: 'ذمم الموردين',             type: 'liability', parent: '200100' },
  OUTPUT_VAT:        { code: '2210', nameAr: 'ضريبة المخرجات',           type: 'liability', parent: '200300' },
  ROYALTY_PAYABLE:   { code: '2310', nameAr: 'مستحقات الامتياز',         type: 'liability', parent: '200200' },
  // ─── Revenue ───
  SALES_REVENUE:     { code: '4100', nameAr: 'إيرادات المبيعات',         type: 'revenue',   parent: '400000' },
  STOCK_GAIN:        { code: '4910', nameAr: 'إيراد فروقات جرد',         type: 'revenue',   parent: '400900' },
  // ─── Expenses ───
  ...
  COGS:              { code: '5100', nameAr: 'تكلفة المبيعات',           type: 'expense',   parent: '500000' },
  WASTE_EXPENSE:     { code: '5200', nameAr: 'مصروف الهدر (عام)',         type: 'expense',   parent: '501800' },
  ...
  WASTE_RAW:         { code: '5200', nameAr: 'مصروف الهدر', type: 'expense', parent: '501800', aliasOf: 'WASTE_EXPENSE' },
  WASTE_FINISHED:    { code: '5200', nameAr: 'مصروف الهدر', type: 'expense', parent: '501800', aliasOf: 'WASTE_EXPENSE' },
  WASTE_EXPIRED:     { code: '5200', nameAr: 'مصروف الهدر', type: 'expense', parent: '501800', aliasOf: 'WASTE_EXPENSE' },
  WASTE_SPILL:       { code: '5200', nameAr: 'مصروف الهدر', type: 'expense', parent: '501800', aliasOf: 'WASTE_EXPENSE' },
  WASTE_RETURNS:     { code: '5200', nameAr: 'مصروف الهدر', type: 'expense', parent: '501800', aliasOf: 'WASTE_EXPENSE' },
  STOCK_VARIANCE:    { code: '5300', nameAr: 'فروقات الجرد',             type: 'expense',   parent: '501800' },
  PPV:               { code: '5350', nameAr: 'فروق سعر المشتريات',       type: 'expense',   parent: '501800' },
  LABOR_APPLIED:     { code: '5400', nameAr: 'العمالة المحملة',           type: 'expense',   parent: '500400' },
  OVERHEAD_APPLIED:  { code: '5410', nameAr: 'التكاليف غير المباشرة',     type: 'expense',   parent: '501800' },
  PRODUCTION_VARIANCE:{ code: '5420', nameAr: 'فروقات الإنتاج',           type: 'expense',   parent: '501800' },
  FRANCHISE_FEE:     { code: '6100', nameAr: 'مصروف رسوم الامتياز',       type: 'expense',   parent: '501700' },
  ...
  PLATFORM_COMMISSION:{ code: '5500', nameAr: 'عمولات منصات التوصيل',      type: 'expense',   parent: '501000' },
  PLATFORM_PAYABLE:  { code: '2320', nameAr: 'مستحقات منصات التوصيل',      type: 'liability', parent: '200200' }
};
...
module.exports = { postJournal, ensureCoreAccounts, resolveAccountId, isPeriodClosed, PERIOD_CLOSED_STATUSES, CORE_ACCOUNTS, nextFlatJournalNumber, nextFlatJENumber };
